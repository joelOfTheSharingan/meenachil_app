...
const AppRoutes: React.FC = () => {
  ...
  return (
    <Routes>
      ...
      <Route path="/my-site-tools" element={<ProtectedRoute allowedRoles={['supervisor']}><MySiteTools /></ProtectedRoute>} />
      <Route path="/inventory" element={<ProtectedRoute allowedRoles={['admin', 'supervisor']}><AllInventoryPage /></ProtectedRoute>} />
      <Route path="/newRequests" element={<ProtectedRoute allowedRoles={['supervisor']}><NewRequestsPage /></ProtectedRoute>} />
      <Route path="/users" element={<ProtectedRoute allowedRoles={['admin']}><UserManagement /></ProtectedRoute>} />
      <Route path="/assign-sites" element={<ProtectedRoute allowedRoles={['admin']}><AssignSites /></ProtectedRoute>} />
      <Route path="/transactions" element={<ProtectedRoute allowedRoles={['admin']}><TransactionLogs /></ProtectedRoute>} />
